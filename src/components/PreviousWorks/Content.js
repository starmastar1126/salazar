                    ...
                    <div className='work'>
                        ...
                        <div className='data'>
                            ...
                            <div className='buttons'>
                                ...
                                {item.github !== '' && <button className='button' onClick={() => { item.private ? alert("This repository is private.\nPlease contact to nolan@minionhub.co") : window.open(item.github, '_blank') }}><img className='icon' src={`${process.env.PUBLIC_URL}/assets/icons/software/git.png`} alt='git' /></button>}
                            </div>
                        </div >
                    </div >
                </div >
